...
param (
  $url = "https://github.com/StefanLauritsen/Powershell/blob/master/MLIT-FileCatalyst.psm1"
)
...
function Install-PSModule {
    ...
    param (
      [string]
      # URL to the respository to download MLIT-FileCatayst from
      $url
    )
